...
df[df == "cds-pgaptmp_003259"] <- "lysR"
df[df == "cds-pgaptmp_003260"] <- "pfp"
df[df == "cds-pgaptmp_003261"] <- "ifp"
...
head(df)
tail(df)
write.table(df, file="TPM_KPN07_operon_annot.tsv", sep="\t", row.names=FALSE)
```

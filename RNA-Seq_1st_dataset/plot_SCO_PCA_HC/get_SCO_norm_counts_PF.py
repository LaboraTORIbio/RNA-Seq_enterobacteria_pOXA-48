...
cols_to_keep = ["GeneID", "Strain", "C325c1\..*", "CF13c1\..*", "H53c1\..*", "J57c1\..*", "K147c1\..*", "MG1655\..*", "PF_EC10*", "PF_KPN04*", "PF_KPN07*", "PF_KPN10*", "PF_KPN15*", "PF_KPN18*"]
...
collapsed_table.to_csv('SCO_norm_counts_PF.tsv', sep="\t", index=False) 
